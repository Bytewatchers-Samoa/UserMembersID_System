**UserMembersID System - Bytewatchers Samoa**
...
**Goals**
- Develop a user-centric ID system that simplifies account creation, login, and identity verification.
- Ensure secure and reliable user management
- 
